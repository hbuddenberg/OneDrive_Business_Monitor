...
class MonitorConfig(BaseModel):
    ...
    log_path: str = "C:\\Users\\YOUR_USERNAME\\AppData\\Local\\Microsoft\\OneDrive\\logs\\Business1\\SyncDiagnostics.log"  # Replace YOUR_USERNAME with your Windows username
